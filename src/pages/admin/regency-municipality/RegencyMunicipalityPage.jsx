  ...
  const fetchCode = async () => {
    try {
      const response = await axios.get(
        `http://localhost:5000/regency-municipalities?search_query=${keyword}&page=${page}&limit=${limit}`
      );
    ...
    <DefaultLayout>
      {openModalAdd && (
        <ModalAddCode
          ...
          codeName="regency-municipalities"
          fetchCode={fetchCode}
        />
      )}
      {openModalDelete && (
                  ...
                  <table className="w-full my-0 align-middle text-dark border-neutral-200">
                    <thead className="align-bottom">
                      <tr className="font-semibold text-[0.95rem] text-secondary-dark">
                        ...
                        <th className="pb-3 text-center">Kabupaten/Kota</th>
...
export default RegencyMunicipalityPage;
